!(function () {
    ...
    function q(t, s) {
        ...
        let { format: d, language: o, locale: c, maxDate: h, maxView: u, minDate: f, pickLevel: p, startView: g, weekStart: m } = s.config || {};
        if (a.language) {
            let e;
        ...
        let y = f,
            k = h;
        if (
            (void 0 !== a.minDate && ((y = null === a.minDate ? l(0, 0, 1) : R(a.minDate, d, c, y)), delete a.minDate),
            void 0 !== a.maxDate && ((k = null === a.maxDate ? void 0 : R(a.maxDate, d, c, k)), delete a.maxDate),
            k < y ? ((f = n.minDate = k), (h = n.maxDate = y)) : (f !== y && (f = n.minDate = y), h !== k && (h = n.maxDate = k)),
            a.datesDisabled &&
        ...
        if (
            (a.daysOfWeekDisabled && ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce($, [])), delete a.daysOfWeekDisabled),
            a.daysOfWeekHighlighted && ((n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce($, [])), delete a.daysOfWeekHighlighted),
        ...
        if ((void 0 !== a.disableTouchKeyboard && ((n.disableTouchKeyboard = "ontouchstart" in document && !!a.disableTouchKeyboard), delete a.disableTouchKeyboard), a.orientation)) {
            ...
            (n.orientation = { x: e.find((e) => "left" === e || "right" === e) || "auto", y: e.find((e) => "top" === e || "bottom" === e) || "auto" }), delete a.orientation;
        }
    ...
    class X {
        constructor(e, t) {
            Object.assign(this, t, { picker: e, element: Y('<div class="datepicker-view"></div>').firstChild, selected: [] }), this.init(this.picker.datepicker.config);
        }
        init(e) {
    ...
    class G extends X {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek && (t.showDaysOfWeek ? (_(this.dow), this.calendarWeeks && _(this.calendarWeeks.dow)) : (W(this.dow), this.calendarWeeks && W(this.calendarWeeks.dow))),
                i &&
    ...
    class le {
        constructor(e) {
            ...
            i.classList.add(`datepicker-${p}`),
                ...
                (this.views = [new G(this), new Z(this), new ee(this, { id: 2, name: "years", cellClass: "year", step: 1 }), new ee(this, { id: 3, name: "decades", cellClass: "decade", step: 10 })]),
        ...
        place() {
            ...
            a === document.body ? ((p = window.scrollY), (g = l + window.scrollX), (m = h + p)) : ((g = l - d), (m = h - o + (p = a.scrollTop))),
                "auto" === w && (g < 0 ? ((w = "left"), (g = 10)) : (w = g + n > c ? "right" : "rtl" === ce(s) ? "right" : "left")),
                "right" === w && (g -= n - u),
    ...
    class me {
        constructor(e, t = {}, i) {
            ...
            const a = (this.config = Object.assign({ buttonClass: (t.buttonClass && String(t.buttonClass)) || "button", container: document.body, defaultViewDate: c(), maxDate: void 0, minDate: void 0 }, q(B, this)));
    ...
    function ke(e, t) {
        ...
        void 0 !== d && void 0 !== o
            ...
            : e.allowOneSidedRange || (void 0 === d && void 0 === o) || ((a.clear = !0), s[r].setDate(s[n].dates, a)),
        ...
        (window.DateRangePicker = class {
            constructor(e, t = {}) {
                ...
                Object.defineProperty(this, "datepickers", { get: () => n }),
                    ...
                    Object.freeze(n),
                    n[0].dates.length > 0 ? ke(this, { target: this.inputs[0] }) : n[1].dates.length > 0 && ke(this, { target: this.inputs[1] });
            }
            get dates() {
