...
@section('title')
Precedentes Administrativos 01 y 02-2020 del Tribunal del Servicio Civil | Alappont
@endsection
...
function updateTimer() {
  future  = Date.parse("June 26, 2020 19:00:00");
  now     = new Date();
  diff    = future - now;
...
<div class="uk-text-center " style="height: 800px;">
            ...
            <h2 class="uk-margin-top">Precedentes Administrativos 01 y 02-2020 del Tribunal del Servicio Civil</h2>
            ...
            <p>Este evento inicia el 26 de junio del 2020 a las 19:00 h. Exactamente en:</p>
