...
@section('title')
Manejando la depresión en tiempos de cuarentena | Alappont
@endsection
...
function updateTimer() {
  future  = Date.parse("June 18, 2020 19:00:00");
  now     = new Date();
  diff    = future - now;
...
<div class="uk-text-center " style="height: 800px;">
            ...
            <h2 class="uk-margin-top">Manejando la depresión en tiempos de cuarentena</h2>
            ...
            <p>Este evento inicia el 18 de junio del 2020 a las 19:00 h. Exactamente en:</p>
