...
function updateTimer() {
  future  = Date.parse("June 12, 2020 ");
  now     = new Date();
  diff    = future - now;
...
<div class="uk-text-center " style="height: 800px;">
            ...
            <h2 class="uk-margin-top">El catastro urbano</h2>
            ...
            <p>Este evento inicia el 12 de junio del 2020 a las 19:00 h. Exactamente en:</p>
